...
/**
 * This is your basic message. It should cover most needs. It supports the
 * following stuff:
 * <ul>
 * <li>Basic attributes:
 * <ul>
 ...
 * <li>IMPORTANT: if your subclass adds an attribute that you need copied, and
 * you want to use these methods, make sure to override them to include your
 * attribute.</li>
 * </ul>
...
public interface Message extends Serializable {
	 ...
	 * will be added to this list. So we can use this to see how this message got to
	 * us.
	 */
	 ...
	 * current node being added to the route list.
	 */
	 ...
	 * before the message is being sent. If the message was held up by an event or a
	 * queue, this ensures that we perform the effect as we are sending the message.
	 */
	void sendEffect();

	/**
	 * Vector clock that is unique per servent. Used to know the order of recived
	 * and sent messages.
	 */
