 ...
 *
 */
public class AcharyaSnapshotResult implements Serializable {
	...
	private final Map<Integer, List<Message>> sentHistory;
	private final Map<Integer, List<Message>> recievedHistory;

	public AcharyaSnapshotResult(int serventId, int recordedAmount, Map<Integer, List<Message>> sentHistory,
			Map<Integer, List<Message>> recievedHistory) {
		this.serventId = serventId;
		this.recordedAmount = recordedAmount;
		this.sentHistory = new ConcurrentHashMap<>(sentHistory);
		this.recievedHistory = new ConcurrentHashMap<>(recievedHistory);
	}
